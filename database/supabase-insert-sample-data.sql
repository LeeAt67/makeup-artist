...
-- ====================================
-- 使用说明：
-- 1. 先在 Supabase 中注册至少一个测试用户
-- 2. 在 Supabase Dashboard -> Authentication -> Users 中找到用户的 UUID
-- 3. 将下面的 'YOUR_USER_UUID_HERE' 替换为实际的用户 UUID
-- 4. 在 Supabase Dashboard -> SQL Editor 中执行此脚本
-- ====================================

-- 定义变量（替换为你的实际用户 UUID）
-- 例如：\set user_id '123e4567-e89b-12d3-a456-426614174000'
...
-- 1. 精选帖子 - 日系清透感妆容
(
  'YOUR_USER_UUID_HERE', -- 👈 替换为实际用户 UUID
  '日系清透感妆容',
  '清新自然的日系妆容，展现真实之美',
  '# 日系清透感妆容教程
...
-- 提示信息
-- ====================================
-- 执行成功后，你应该能看到 8 条妆容记录
-- 记得将 'YOUR_USER_UUID_HERE' 替换为实际的用户 UUID！
